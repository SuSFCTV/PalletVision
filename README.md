...
## Запуск проекта
Для запуска проекта вам потребуется настроить среду с необходимыми библиотеками и запустить скрипт для обработки изображений. Пошаговая инструкция **ПОКА ПРИМЕРНАЯ**:
...
---
**Тоже надо в норм формате а не лапшой текста**
